...
namespace PedometerU.Utilities {
    ...
    public class PedometerEditor : IPreprocessBuild, IPostprocessBuild, IOrderedCallback {
		...
		void IPreprocessBuild.OnPreprocessBuild(BuildTarget target, string path) {
				...
				File.Copy(Path.Combine(Environment.CurrentDirectory, "Assets/Plugins/Android/libs/Sensors/AndroidManifest.xml"), Path.Combine(AndroidPlugins, "AndroidManifest.xml"));
			#elif UNITY_IOS
